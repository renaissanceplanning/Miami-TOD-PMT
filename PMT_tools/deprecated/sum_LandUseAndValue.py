...
def sumLandUseAndValue(station_polys,
    ...
    cor_sum_fc = PMT.make_path(output_gdb, "Corridors", "land_use_and_value_cor")
    ...
    stn_sum_fc = PMT.make_path(output_gdb, "StationAreas", "land_use_and_value_sa")
...
if __name__ == "__main__":
    ...
    for year in PMT.YEARS:
        print(year)
        out_gdb = PMT.make_path(PMT.ROOT, f"PMT_{year}.gdb")
        parcels = PMT.make_path(out_gdb, "parcels", "land_use_and_value")
        sumLandUseAndValue(station_areas,
                           ...
                           parcel_id="PARCELNO")
        stn_sum_fc = PMT.make_path(
            out_gdb, "StationAreas", "land_use_and_value_sa")
        cor_sum_fc = PMT.make_path(
