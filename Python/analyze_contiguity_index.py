...
def analyze_contiguity_index(parcels_path,
    ...
    arcpy.CreateFishnet_management(
        out_feature_class=r"in_memory\\quadrats",
    ...
    arcpy.da.NumPyArrayToFeatureClass(
        ...
        out_table=r"in_memory\\centroids",
    ...
    arcpy.Intersect_analysis(
        in_features=[r"in_memory\\centroids",
                     r"in_memory\\quadrats"],
        out_feature_class=r"in_memory\\intersect"
    )
    arcpy.Delete_management(r"in_memory\\quadrats")
    arcpy.Delete_management(r"in_memory\\centroids")
    ...
    for i in chunk_ids:
        ...
        parcel_chunk = arcpy.SelectLayerByAttribute_management(
            in_layer_or_view=r"in_memory\\diff",
            selection_type="NEW_SELECTION",
        ...
        rp = ''.join([r"in_memory\\chunk_raster_", str(i)])
