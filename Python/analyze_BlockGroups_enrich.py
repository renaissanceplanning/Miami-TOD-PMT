...
#     except:
#         bg_ws, bg_name = os.path.split(bg_fc)
#         bg = gpd.read_file(bg_ws, layer=bg_name, driver="OpenFileGDB")
#     # Read parcel data
#     try:
#         parcels = gpd.read_file(parcels_fc)
#     except:
#         par_ws, par_name = os.path.split(parcels_fc)
#         parcels = gpd.read_file(par_ws, layer=par_name, driver="OpenFileGDB")
#     print("...flattening parcel records")
#     parcels = parcels.groupby(par_id_field).mean()
#     # Project bg features into parcel crs
#     print("...projecting block groups")
...
#     print("...joining block groups to parcels based on parcel centroid location")
#     parcels = gpd.sjoin(parcels, bg, how='inner', op='within')
    
#     # Summarize requested fields
#     print("...summarizing parcel fields to block group")
#     if par_sum_fields:
#         print(f"... ...{par_sum_fields}")
...
#     #bg.to_file(out_fc)
#     #return out_fc
#     print(f"... exporting output features ({out_fc})")
#     return PMT.gdfToFeatureClass(bg, out_fc, sr=gdf.crs.to_wkt())
